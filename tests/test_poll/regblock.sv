...
module regblock #(
        ...
        output logic [0:0] hwif_out_start,
        input wire [0:0] hwif_in_busy
    );
    ...
    // Address Decode
    //--------------------------------------------------------------------------
    logic [0:0] decoded_reg_strb_start;
    ...
    logic [0:0] field_storage_start_value;
    logic [0:0] field_combo_start_next;
...
//--------------------------------------------------------------------------
    ...
    assign readback_array[0][0:0] = (decoded_reg_strb_start && !decoded_req_is_wr) ? field_storage_start_value : '0;
    assign readback_array[0][31:1] = '0;
    assign readback_array[1][0:0] = (decoded_reg_strb_busy && !decoded_req_is_wr) ? hwif_in_busy : '0;
