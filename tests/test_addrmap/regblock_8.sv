...
module regblock #(
        ...
        input wire [1:0] s_obi_addr,
        input wire s_obi_we,
        input wire [0:0] s_obi_be,
        input wire [7:0] s_obi_wdata,
        input wire [ID_WIDTH-1:0] s_obi_aid,
        output logic s_obi_rvalid,
        input wire s_obi_rready,
        output logic [7:0] s_obi_rdata,
    ...
    always @(*) begin
        ...
        /* verilator lint_on UNUSEDSIGNAL */
        decoded_reg_strb_status = cpuif_req_masked & (cpuif_addr == 2'h0);
        decoded_reg_strb_busy = cpuif_req_masked & (cpuif_addr == 2'h1);
        decoded_reg_strb_config = cpuif_req_masked & (cpuif_addr == 2'h2);
        decoded_reg_strb_interrupt = cpuif_req_masked & (cpuif_addr == 2'h3);
    end
