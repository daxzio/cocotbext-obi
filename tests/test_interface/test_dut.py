"""
test_basic-style test using cocotbext-interface style OBI (ObiInterface).
The only difference from test_basic is the bus object: ObiInterface instead
of ObiBus.  ObiHost and ObiMonitor are used unchanged.
"""
...
class testbench:
    def __init__(self, dut, reset_sense=1, period=10):
        ...
        obi_prefix = "s_obi"
        self.bus = ObiInterface.from_prefix(dut, obi_prefix)
        clk_name = "clk"
